...
* 参考： 
  * [How do you find out a laptop screen panel manufacturer / model with Linux? (Samsung, LG, Chi Mei, etc)](https://superuser.com/a/628042)
  * []()
...
1. 打印出显示信息
    ~~~
    /sys/class/drm# cat card0-HDMI-A-1/edid | edid-decode
    ~~~

    ~~~
    edid-decode (hex):

    00 ff ff ff ff ff ff 00 10 ac f4 40 42 4c 37 32
    13 1a 01 03 80 33 1d 78 ea eb f5 a6 56 51 9c 26
    10 50 54 a5 4b 00 71 4f 81 80 a9 c0 d1 c0 01 01
    01 01 01 01 01 01 02 3a 80 18 71 38 2d 40 58 2c
    45 00 fd 1e 11 00 00 1e 00 00 00 ff 00 32 4a 30
    36 52 36 35 35 32 37 4c 42 0a 00 00 00 fc 00 44
    45 4c 4c 20 50 32 33 31 37 48 0a 20 00 00 00 fd
    00 38 4c 1e 53 11 00 0a 20 20 20 20 20 20 01 fb
    ...
    Block 0, Base EDID:
      ...
      Vendor & Product Identification:
        Manufacturer: DEL
        Model: 16628
        Serial Number: 842484802
        Made in: week 19 of 2016
      ...
      Detailed Timing Descriptors:
        ...
        Display Product Serial Number: '2J06R65527LB'
