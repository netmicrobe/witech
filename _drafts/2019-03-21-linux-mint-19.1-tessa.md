...
* ref
  ...
  * [Radeon™ Software for Linux® 18.40 Highlights](https://www.amd.com/en/support/kb/release-notes/rn-prorad-lin-18-40)
...
* [How do I install AMDGPU-Pro on Mint 19?](https://forums.linuxmint.com/viewtopic.php?t=272074)

1. 是否已安装 AMDGPU-Pro Driver
    ~~~
    # find out if you have AMDGPU-Pro already installed
    dpkg -l amdgpu-pro
    ~~~
1. 下载 [AMDGPU-PRO Driver Version 17.40 for Ubuntu 16.04.3](https://www2.ati.com/drivers/linux/ubuntu/amdgpu-pro-17.40-492261.tar.xz)
1. 解压
    ~~~
    cd /tmp
...
1. 安装ROCm 「可选」
    ...
    # csh 设置
    echo 'setenv LLVM_BIN /opt/amdgpu-pro/bin' | sudo tee /etc/profile.d/amdgpu-pro.cs
    ~~~
